    ...
    <div className={s.information}>
      <div className={s.social}>
        ...
        <div className={s.icons}>
          <a className="_icon-Facebook" href="https://www.facebook.com/"></a>
          <a className="_icon-Twitter" href="https://twitter.com/"></a>
          <a className="_icon-YouTube" href="https://www.youtube.com/"></a>
          <a className="_icon-Telegram" href="#"></a>
          <a className="_icon-Instagram" href="https://www.instagram.com/"></a>
          <a className="_icon-Linked-In" href="https://www.linkedin.com/"></a>
        </div>
      </div>
